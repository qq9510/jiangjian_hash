...
#define KEY_LEN 32                    // The maximum length of a key
#define VALUE_LEN 31                  // The maximum length of a value
#define READ_WRITE_NUM 1000000        // The total number of read and write operations in the workload
